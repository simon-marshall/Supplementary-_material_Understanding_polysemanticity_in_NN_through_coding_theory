...
Write a brief paragraph for a README that describes the above code. Write the paragraph in a way that makes no reference to the above code, i.e. don't say 'the above code'.